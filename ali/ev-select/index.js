...
Component({
  ...
  didUpdate() {
    if (
      ...
      this.data.value !== this.props.disabledValue
    ) {
    ...
    if (
      ...
      this.data.defaultValue !== this.props.defaultValue
    ) {
      this.setData({
    ...
    if (
      this.props.propValue != null &&
      this.data.value !== this.props.propValue
    ) {
      console.log("componentDidUpdate", this.props);
      this.setData({
        value: this.props.propValue,
      });
      this.props.onChange && this.props.onChange(this.props.propValue);
    }
    this.props.onRef && this.props.onRef(this);
  },
  didUnmount() {},
